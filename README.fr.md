...
> **Démo en ligne :** pilotez le cœur de confiance vous-même — [**cae-demo.breizhland.eu**](https://cae-demo.breizhland.eu) fait tourner le vrai coordinateur et un LLM local sur un sandbox OPNsense isolé, avec un miroir live des étapes (un visiteur pilote, les autres regardent).
>
